...
class PopUpStergereContAdmin extends Component {
    constructor(props) {
        super(props)
    }
            ...
            <div>
                ...
                >
                    ...
                    <DialogActions className={classes.root}>
                        <Button onClick={() => { this.props.stergeAdmin()}} className={classes.submit}>
                            Da
                        </Button>
...
export default withStyles(styles)(PopUpStergereContAdmin);