...
import { profesoriRoute, activitateProfRoute } from '../../Routes/ApiRouter'
...
import CardActivitatiCadreDidactice from './CardActivitatiCadreDidactice';
import { TextCenter } from 'react-bootstrap-icons/build';
...
class FiltreazaActivitatiCadreDidactice extends Component {
    constructor(props) {
        super(props)
    ...
    render() {
        ...
        return (
            <div>
                ...
                <CardActivitatiCadreDidactice activitati={this.state.activitati} afiseazaActivitate={this.afiseazaActiv} />
                <Alerts
...
export default withStyles(styles)(FiltreazaActivitatiCadreDidactice);