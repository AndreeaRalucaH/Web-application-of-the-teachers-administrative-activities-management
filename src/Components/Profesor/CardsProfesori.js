                                ...
                                <CardActionArea  >
                                    <CardContent  >
                                        <div onClick={() => {
                                            ...
                                            // this.setState({ activitateId: activ.ActivitateID })
                                            ...
                                            <Grid item xs={3} sm={12}>
                                                <Tooltip title="Editeaza">
                                                    <Pencil
                                                        ...
                                                        onClick={() => {
                                                            this.props.onChangeIdActivitate(activ.ActivitateID)
                                                            if(activ.Atasamente[0]===undefined)
                                                            {
                                                                this.props.onChangeIdAtasament(0)
                                                            }else{
                                                                this.props.onChangeIdAtasament(activ.Atasamente[0].AtasamentID)
                                                            }
